...
export const metadata = buildMarketingPageMetadata("/terms");

export default function TermsPage() {
  return (
    <MarketingSection eyebrow="Legal" title={marketingLegalPlaceholder.termsTitle}>
      <div className="mx-auto max-w-2xl rounded-2xl border border-dashed bg-card p-8 shadow-xs">
        ...
        <p className="mt-4 text-xs uppercase tracking-wider text-muted-foreground">
          Status: {marketingLegalPlaceholder.status.terms}
        </p>
        <div className="mt-8">
